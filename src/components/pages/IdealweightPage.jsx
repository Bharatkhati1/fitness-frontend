...
<section className="InnnerPage bmiCalculator InnerSpace">
   <div className="container">
      <div className="InnerPageTitle">
         ...
         <p>
            Ideal weight is the estimated body weight range that is considered
            healthiest for an individual based on factors like height, age,
            ...
            <div className="calulaterResult calulaterDiet">
               ...
               <div className="ResultBox">
                  <div className="ResultBox-left">
                     <p>
                        According to Hamwi’s Formula,{" "}
                        <span className="text-primary">
                        your Ideal Weight is:
                        </span>
                     </p>
                     <span className="day-text">165.3 lbs</span>
                  </div>
